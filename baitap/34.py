...
def pipeline_model(img_path):
    ...
    faceDetectionModel = os.path.join(path, 'models-20241025T083618Z-001/models/res10_300x300_ssd_iter_140000_fp16.caffemodel')
 
    # Face detection model architecture
    faceDetectionProto = os.path.join(path, 'models-20241025T083618Z-001/models/deploy.prototxt.txt')
 
    # Face descriptor model
    faceDescriptor = os.path.join(path, 'models-20241025T083618Z-001/models/openface.nn4.small2.v1.t7')
...
image_path = os.path.join(path, 'FaceImage-20241025T092759Z-001/FaceImage/172100251_NguyenHaiDuy/imageAAA_2220.jpg')
